...
public class Example2 {
    public static void main(String[] args) {
        ...
        // 1. 컬렉션 프레임워크는 스트림 제공한다.  .stream().forEach()
